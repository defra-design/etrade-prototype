module.exports = function(router) {
  ...
  const base_url = "beta/v2-1/application/export/"
        ...
        readXlsxFile(path_and_filename).then((rows, errors) => {
          ...
          if (rows[0][1].substring(0,3).toLowerCase() == "ehc") {
            ...
            if (rows_of_uploaded_data == 0) {
              ...
              // parse the certificate number from the uploaded data - we may discard this later, but it coudl be useful
              ...
              if (typeof cert_schema !== 'undefined') {
                ...
                res.redirect(301, '/' + base_url + 'upload/processing?totalRows=' + rows_of_uploaded_data + "&errorRowCount=" + errorRowCount + "&numberOfErrors=" + data_errors.length + "&fluffRows=" + rows_of_fluff + errorString);
